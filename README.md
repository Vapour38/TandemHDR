...
The tray icon will reflect if HDR is on or off, and left-clicking toggles HDR. Right-click opens the Settings.
...
`.icc` / `.icm` files. Settings are stored in the registry under `HKCU\Software\Tandem HDR`. 
